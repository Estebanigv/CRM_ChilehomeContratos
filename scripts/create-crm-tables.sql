-- Script para crear las tablas necesarias para el CRM sync
-- Ejecutar este SQL directamente en la consola de Supabase
...
DROP TRIGGER IF EXISTS update_ventas_crm_updated_at ON ventas_crm;
...
CREATE INDEX IF NOT EXISTS idx_crm_sync_log_sync_type ON crm_sync_log(sync_type);
